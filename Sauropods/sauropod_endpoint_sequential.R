...
p_exceedances <- ggplot(results, aes(x = year, y = n)) +
  ...
  labs(title = "Number of Threshold-Exceeding Specimens Over Time",
       x = "Year", y = "Count > u") +
  theme_minimal(base_size = 14)+scale_x_continuous(limits = c(1870, max(results$year)))
p_exceedances
...
extremo_data <- results %>%
  ...
  select(year, mass_quad, pi_lower_quad, pi_upper_quad, species, type)
...
plot_data$species <- factor(
  plot_data$species,
  levels = c("Ruyangosaurus", "Turiasaurus", "Yunmenglong", "Australotitan", "Patagotitan",
...
species_colors <- c(
  "Ruyangosaurus" = "#a6cee3",
  "Turiasaurus" = "#1f78b4",
  "Yunmenglong" = "#b2df8a",
  "Australotitan" = "#33a02c",
  "Patagotitan" = "#fb9a99",
  "Dreadnoughtus" = "#e31a1c",
  "Notocolossus" = "#fdbf6f",
  "Chucarosaurus" = "#ff7f00",
  "Brachiosaurus" = "#cab2d6",
  "Argentinosaurus" = "#6a3d9a",
...
## --- log-mass plot WITHOUT Argentinosaurus ----------------------------------
...
# List of plot objects including all "no_x" variants and new plots
plot_list <- list(
  p_CFH,
  p_log_CFH,
  p_exceedances,
...
file_names <- c(
  "sequential_endpoint",
  "sequential_log_endpoint",
  "exceedances_over_time",
  "sequential_mass_endpoint",
  "sequential_mass_endpoint_no_title_text_ticks",
  "sequential_mass_endpoint_no_title",
  "sequential_mass_endpoint_no_text",
  "sequential_mass_endpoint_no_ticks",
  "sequential_mass_endpoint_no_title_text",
  "sequential_mass_endpoint_no_title_ticks",
  "sequential_mass_endpoint_no_text_ticks",
  "sequential_log_mass_endpoint",
  "sequential_log_mass_endpoint_no_title_text_ticks",
  "sequential_log_mass_endpoint_no_title",
  "sequential_log_mass_endpoint_no_text",
  "sequential_log_mass_endpoint_no_ticks",
  "sequential_log_mass_endpoint_no_title_text",
  "sequential_log_mass_endpoint_no_title_ticks",
  "sequential_log_mass_endpoint_no_text_ticks",
  "sequential_log_mass_endpoint_no_extremo",
  "sequential_log_mass_endpoint_no_extremo_no_title_text_ticks",
  "sequential_log_mass_endpoint_no_extremo_no_title",
  "sequential_log_mass_endpoint_no_extremo_no_text",
  "sequential_log_mass_endpoint_no_extremo_no_ticks",
  "sequential_log_mass_endpoint_no_extremo_no_title_text",
  "sequential_log_mass_endpoint_no_extremo_no_title_ticks",
  "sequential_log_mass_endpoint_no_extremo_no_text_ticks",
  "posterior_logCFH",
  "posterior_mass_lin",
  "posterior_mass_quad"
)
